    ...
    return (
        <div className="min-h-screen h-screen flex flex-col bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-50 relative overflow-hidden">
            ...
            <div className="flex-1 relative h-full min-h-screen sm:min-h-0">
                ...
                {/* Mobilde sağ alt köşede eşleşmeleri gör butonu */}
                <button
                    className="fixed bottom-20 right-5 z-[100] flex sm:hidden items-center gap-2 px-5 py-3 rounded-full bg-pink-600 text-white shadow-lg text-base font-semibold hover:bg-pink-700 transition-all"
                ...
                >
                    ...
                    {pendingMatchesCount > 0 && (
                        <span className="ml-2 bg-red-500 text-white text-xs font-bold rounded-full h-5 min-w-5 flex items-center justify-center px-1">
                            {pendingMatchesCount}
                        </span>
                    )}
                </button>
